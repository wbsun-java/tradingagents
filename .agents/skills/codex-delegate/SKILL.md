---
name: codex-delegate
description: Use when implementing a plan task for TradingAgents backend/agent code (stage 3 of the Codex-architect workflow) - drives Codex CLI non-interactively to write the module and its tests, self-verify, and iterate via resume before escalating to the user.
---
